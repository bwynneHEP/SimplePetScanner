...
SiemensQuadraParameterisationBlocks::SiemensQuadraParameterisationBlocks()
{
}
...
void SiemensQuadraParameterisationBlocks::ComputeTransformation( const G4int copyNo, G4VPhysicalVolume* physVol ) const
{
  ...
  //vis->SetColor( 0.0, G4double( copyNo ) / 1216.0, 0.0, 1.0 );
  vis->SetColor( 0.0, G4double( rand() % 1216 ) / 1216.0, 0.0, 1.0 );
